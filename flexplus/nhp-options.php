...
$args['opt_name'] = 'flexplus_options';
...
$args['page_title'] = __('FlexPlus Theme Options', 'nhp-opts');
...
$sections = array(); 
$sections[] = array(
				'title' => __('Global Options', 'nhp-opts'),
				'desc' => __('<p class="description">Some basic global options for your theme.</p>','nhp-opts'),
				'icon' => NHP_OPTIONS_URL.'img/glyphcions/glyphicons_023_cogwheels.png',
				'fields' => array(
				array(
				'id' => '001',
				'type' =>'upload',
				...
				'id'=>'002',
				'type'=>'editor',
				'title' =>__('Copyright Message','nhp-opts'),
				'sub_desc' =>__('Enter (a brief) copyright message that will show up at the bottom of your site','nhp-opts'),
				),
				array(
				'id'=>'003',
				'type'=>'radio',
				'title'=>__('Show Site Credit Link?','nhp-opts'),
				'sub_desc' =>__('A lot of love went into making this site, so please show your appreciation by letting us leave a tiny link at the bottom of your page.  Thanks.','nhp-opts'),
				'options' => array('inline' =>__('Show','nhp-opts'), 'none' =>__('Hide','nhp-opts')),
				'std'=> 'inline',
				)
				)
				);
$sections[] = array(
				...
				'desc' => __('<p class="description">Set the options for your header.</p>', 'nhp-opts'),
				//all the glyphicons are included in the options folder, so you can hook into them, or link to your own custom ones.
				//You dont have to though, leave it blank for default.
				...
				'sub_desc'=>__('Make sure that the maximum width for the file is 300px. jpg, .gif or .png files are best.','nhp-opts')
				),
				array(
				'id' =>'103',
				'type' =>'radio',
				'title' => __('Hide Text Site Title?','nhp-opts'),
				'sub_desc' =>__('This is a really good idea if you are using an image above.','nhp_opts'),
				'options' => array('inline' =>__('Show','nhp-opts'), 'none' =>__('Hide','nhp-opts')),
				'std' =>'Hide'
				),
				...
				'id' => '102',
				'type' => 'radio',
				'title' => __('Hide Tagline?','nhp-opts'),
				'sub_desc' => __('Site tagline is hidden by default.','nhp-opts'),
				'options'=> array('block' =>__('Show','nhp-opts'), 'none' =>__('Hide','nhp-opts')),
				'std' =>'Hide'
				),
				array(
				'id' =>'101',
				...
				'sub_desc' =>__('Set the background color for the header','nhp-opts'),
				'std' => '#FFFFFF'
				)
				)
				);
...
$sections[] = array(
				'title' =>__('Navigation Style Options','nhp-opts'),
				'desc' =>__('<p class="description">Set the style options for the navigation bar.','nhp-opts'),
				'icon' => NHP_OPTIONS_URL.'img/glyphcions/glyphicons_023_cogwheels.png',
				'fields'=> array(
				...
				'id' => '200',
				'type' =>'color',
				'title' =>__('Main Navigation Bar Background Color','nhp-opts'),
				'std'=>'#4D4D4D',
				...
				'id' =>'201',
				'type'=>'color',
				'title'=>__('Menu Item Hover Color','nhp-opts'),
				'std' =>'#2BA6CB',
				)
				)
				);	
